...
NexusUnitTesting:RegisterUnitTest(OutputViewUnitTest.new("UpdateDisplayedOutput"):SetRun(function(self)
	...
	self:AssertEquals(self.CuT.OutputLabels[1].Text,"No Output","Text is incorrect.")
	self:AssertEquals(self.CuT.OutputLabels[1].Font,Enum.Font.SourceSansItalic,"Font is incorrect.")
	...
	self:AssertEquals(self.CuT.OutputLabels[1].Font,Enum.Font.SourceSans,"Font is incorrect.")
